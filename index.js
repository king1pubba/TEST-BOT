...
async function connectToWA() {
  ...
  console.log("Connecting QUEEN SP BOT");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("QUEEN SP BOT installed successful ✅");
      console.log("QUEEN SP BOT connected to whatsapp ✅");

      let up = `QUEEN SP BOT connected successful ✅`;
      let up1 = `Hello KE4Nzer, I made bot successful`;
      ...
      robin.sendMessage("94776290170@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Dark-Robin/Bot-Helper/refs/heads/main/autoimage/Bot%20robin%20cs.jpg`,
        },
        caption: up1,
